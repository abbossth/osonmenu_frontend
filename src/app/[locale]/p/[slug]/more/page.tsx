  ...
  return (
    <div className="min-h-screen bg-[#ececea] text-neutral-900">
      <div className="mx-auto w-full max-w-[620px] px-4 pb-24 pt-4">
        ...
        <h1 className="mt-5 text-3xl font-semibold text-neutral-800">More</h1>
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
          {cards.map((card) => (
            <button
              ...
              type="button"
              onClick={() => {
                if (card.id === "team") router.push(`/${locale}/p/${slug}/team`);
                if (card.id === "billing") router.push(`/${locale}/p/${slug}/billing`);
                if (card.id === "help") router.push(`/${locale}/p/${slug}/help`);
              }}
